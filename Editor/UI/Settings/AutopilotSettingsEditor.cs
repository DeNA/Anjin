...
namespace DeNA.Anjin.Editor.UI.Settings
{
    ...
    public class AutopilotSettingsEditor : UnityEditor.Editor
    {
        ...
        private static readonly string s_exitCodeTooltip = L10n.Tr("Autopilot exit code options when lifespan expired.");
        private static readonly string s_customExitCode = L10n.Tr("Custom Exit Code");
        private static readonly string s_customExitCodeTooltip = L10n.Tr("Specify the exit code as an integer value.");
        private static readonly string s_exitMessage = L10n.Tr("Message");
        private static readonly string s_exitMessageTooltip = L10n.Tr("Message sent by the Reporter when lifespan expired.");
